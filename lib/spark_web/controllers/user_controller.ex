defmodule SparkWeb.UserController do
  use SparkWeb, :controller

  alias Spark.Logging
  alias Spark.Account
  alias Spark.Account.User
  alias Spark.Auth.Guardian
  ...
  def login(conn, _params) do
      changeset = Account.change_user(%User{})
      render conn, "login.html", layout: {SparkWeb.LayoutView, "center.html"}, changeset: changeset
  end
  ...
  case Account.authenticate_user(user, password) do
    {:ok, user} ->
      ...
      |> render("login.html", layout: {SparkWeb.LayoutView, "center.html"}, changeset: changeset)        
        else
  ...
  def locked(conn, _) do
    ...
    conn
    |> Guardian.logout
    |> render("locked.html", layout: {SparkWeb.LayoutView, "center.html"}, name: name, avatar: avatar, username: username, changeset: changeset)
  end
